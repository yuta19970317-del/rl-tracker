...
const UPDATES: UpdateEntry[] = [
  ...
  },
  {
    ...
    description:
      "疫病神の定義を「勝率最下位」から「現在3連敗以上」に変更しました。複数人が3連敗中の場合は全員が疫病神になります。3連敗者がいない場合は疫病神カードに勝率王を表示します。また疫病神の在任履歴（いつ3連敗になり、いつ脱出したか）をランキングページに追加しました。個人成績カードとバッジの疫病神判定も同様に更新しています。",
    badge: "NEW",
    icon: "☠️",
    iconColor: "text-red-400",
    iconBg: "bg-red-900/40",

...
const UPDATES: UpdateEntry[] = [
  {
    ...
    description:
      "個人成績ページをゲームのキャラクターカード風にリニューアル。称号に応じてカードのテーマカラーが変化します（疫病神=赤、ゴール王=オレンジ炎、勝率王=ゴールド、守護神=ブルー、アシスト王=グリーン、決定力王=パープル、撃ちたがり=ピンク）。ホバーで発光エフェクト付き。プレイスタイルラベルを自動算出して表示します。",
    badge: "UI",
    icon: "🎮",
